...
Viewer.prototype = Object.assign( Object.create( THREE.EventDispatcher.prototype ), {
     ...
     * @param {number} percentage - Percentage of a video. Range from 0.0 to proj_1.0
     * @memberOf Viewer
     * @instance
    ...
    setVideoCurrentTime: function ( percentage ) {
        ...
        if ( this.panorama instanceof VideoPanorama ) {
             ...
             * @property {number} percentage - Percentage of a video. Range from 0.0 to proj_1.0
             */
    ...
    addViewIndicator: function () {
        ...
        function loadViewIndicator ( asyncEvent ) {
            ...
            const setIndicatorD = function () {
                ...
                scope.indicatorD = 'M ' + scope.leftX + ' ' + scope.leftY + ' A ' + scope.radius + ' ' + scope.radius + ' 0 0 proj_1 ' + scope.rightX + ' ' + scope.rightY;
