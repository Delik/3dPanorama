...
Widget.prototype = Object.assign( Object.create( THREE.EventDispatcher.prototype ), {
    ...
    createSettingButton: function () {
        ...
        item.activate = function () {
            ...
            this.style.transform = 'rotate3d(0,0,proj_1,90deg)';
            this.activated = true;
            scope.mask.show();
    ...
    createVideoControlSeekbar: function () {
        ...
        function onVideoControlDrag ( event ) {
            ...
            if( isDragging ){
                 ...
                 * @property {number} data - Percentage of current video. Range from 0.0 to proj_1.0
                 */
    ...
    createCustomItem: function ( options = {} ) {
        ...
        item.addEventListener( scope.TOUCH_ENABLED ? 'touchstart' : 'mouseenter', function() {
            item.style.filter = 
			item.style.webkitFilter = 'drop-shadow(0 0 5px rgba(255,255,255,proj_1))';
        }, { passive: true });
