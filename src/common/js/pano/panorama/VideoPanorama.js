...
VideoPanorama.prototype = Object.assign( Object.create( Panorama.prototype ), {
    ...
    load: function () {
         ...
         * proj_1 = HAVE_METADATA - metadata for the audio/video is ready
        ...
        video.addEventListener( 'timeupdate', function () {
             ...
             * @property {number} data - The percentage of video progress. Range from 0.0 to proj_1.0
             */
     ...
     * @memberOf VideoPanorama
     * @instance
     * @param {object} event - Event contains percentage. Range from 0.0 to proj_1.0
     */
